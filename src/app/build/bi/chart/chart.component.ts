...
export class ChartComponent implements OnInit, OnDestroy {
    ...
    update(loading: boolean) {
        if (this.plot) {
            ...
            this.biDataService
                .getBiChart(this.bi.code, this.chart.id, this.handlerService.buildDimParam(this.bi))
                .subscribe((data) => {
    ...
    render(element, data: any[]) {
        ...
        switch (this.chart.type) {
            ...
            case ChartType.PercentStackedBar:
                // @ts-ignore
                this.plot = new PercentageStackBar(
                    element,
                    Object.assign(props, {
                        stackField: series,
                    })
            ...
            case ChartType.PercentageArea:
                // @ts-ignore
                this.plot = new PercentageStackArea(
                    element,
                    Object.assign(props, {
                        stackField: series,
                    })
