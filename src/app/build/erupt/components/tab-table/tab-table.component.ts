...
import { STComponent, STColumn, STColumnButton } from '@delon/abc/st';
...
export class TabTableComponent implements OnInit {
                        ...
                        this.modal.create({
                            ...
                            nzOnOk: async () => {
                                ...
                                let result = await this.dataService
                                    .eruptDataValidate(
                                        this.tabErupt.eruptBuildModel.eruptModel.eruptName,
                                        obj,
    ...
    addData() {
        ...
        this.dataService
            .getInitValue(this.tabErupt.eruptBuildModel.eruptModel.eruptName, this.eruptBuildModel.eruptModel.eruptName)
            .subscribe((data) => {
                ...
                this.modal.create({
                    ...
                    nzOnOk: async () => {
                        ...
                        let result = await this.dataService
                            ...
                            .then((resp) => resp);
                        if (result.status == Status.SUCCESS) {
                            obj[this.tabErupt.eruptBuildModel.eruptModel.eruptJson.primaryKeyCol] = -Math.floor(
                                Math.random() * 1000
                            );
