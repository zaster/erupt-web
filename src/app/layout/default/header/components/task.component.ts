        ...
        <a nz-dropdown nzTrigger="click" nzPlacement="bottomRight" (nzVisibleChange)="change()">
            ...
            <div nz-menu class="wd-lg">
                ...
                >
                    ...
                    <div nz-row [nzJustify]="'center'" [nzAlign]="'middle'" class="py-sm bg-grey-lighter-h point">
                        <div nz-col nzFlex="auto" [nzSpan]="4" class="text-center">
                            <nz-avatar [nzSrc]="'./assets/tmp/img/5.png'"></nz-avatar>
                        </div>
                        <div nz-col nzFlex="auto" [nzSpan]="20">
                            <strong>Jefferson</strong>
                            <p class="mb0">Please tell me what happened in a few words, don't go into details.</p>
                        </div>
                    </div>
                    <div nz-row>
                        <div nz-col nzFlex="auto" [nzSpan]="24" class="pt-md border-top-1 text-center text-grey point">
                            See All
                        </div>
                    </div>
                </nz-card>
