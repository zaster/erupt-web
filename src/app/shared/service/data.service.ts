...
export class DataService {
    ...
    static postExcelFile(url, params?: object) {
    ...
    getEruptActionTpl(eruptName: string, code: string, ids: any[]) {
        return (
            RestPath.tpl +
            '/action_tpl/' +
            eruptName +
    ...
    findAutoCompleteValue(
        ...
        field: string,
        val: string,
        eruptParentName?: string
    ): Observable<string[]> {
        return this._http.get<string[]>(
            RestPath.comp + '/auto-complete/' + eruptName + '/' + field,
            {
                val: val.trim(),
            },
            {
    ...
    execOperatorFun(eruptName: string, operatorCode: string, ids: any, param: object) {
        return this._http.post(
            RestPath.data + '/' + eruptName + '/operator/' + operatorCode,
            {
                ids: ids,
                param: param,
            },
    ...
    downloadExcel2(eruptName: string, condition: any) {
        ...
        DataService.postExcelFile(
            RestPath.excel + '/export/' + eruptName + '?' + this.createAuthParam(eruptName),
            param
        );
    }
    ...
    downloadExcel(eruptName: string, condition: any, callback) {
        this._http
            .post(RestPath.excel + '/export/' + eruptName, condition, null, {
    ...
    createAuthParam(eruptName: string): string {
        return (
            DataService.PARAM_ERUPT +
            '=' +
            eruptName +
            '&' +
            DataService.PARAM_TOKEN +
            '=' +
            this.tokenService.get().token
        );
    }
